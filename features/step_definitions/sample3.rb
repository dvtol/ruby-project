...
Given /^startup the framework and visit otwn website3/ do
...
When /^we click the 'hello world' link3/ do
...
Then /^the hello word page opens and we quit the browser3/ do
